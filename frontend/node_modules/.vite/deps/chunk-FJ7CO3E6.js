  ...
  async getRelays() {
    ...
    return NSchema.json().pipe(
      external_exports.record(
        ...
        external_exports.object({ read: external_exports.boolean(), write: external_exports.boolean() })
      )
    ).parse(result);
  }
...
//# sourceMappingURL=chunk-FJ7CO3E6.js.map
