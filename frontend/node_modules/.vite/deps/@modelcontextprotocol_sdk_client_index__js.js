...
var Client = class extends Protocol {
  ...
  _setupListChangedHandlers(config2) {
    ...
    if (config2.tools && ((_b = (_a = this._serverCapabilities) == null ? void 0 : _a.tools) == null ? void 0 : _b.listChanged)) {
    ...
    if (method === "elicitation/create") {
      const wrappedHandler = async (request, extra) => {
        ...
        if (params.mode === "form" && validatedResult.action === "accept" && validatedResult.content && requestedSchema) {
          if ((_b = (_a2 = this._capabilities.elicitation) == null ? void 0 : _a2.form) == null ? void 0 : _b.applyDefaults) {
            try {
  ...
  assertCapability(capability, method) {
    var _a;
    if (!((_a = this._serverCapabilities) == null ? void 0 : _a[capability])) {
  ...
  assertCapabilityForMethod(method) {
    ...
    switch (method) {
      case "logging/setLevel":
        if (!((_a = this._serverCapabilities) == null ? void 0 : _a.logging)) {
  ...
  assertNotificationCapability(method) {
    ...
    switch (method) {
      case "notifications/roots/list_changed":
        if (!((_a = this._capabilities.roots) == null ? void 0 : _a.listChanged)) {
  ...
  assertTaskCapability(method) {
    var _a, _b;
    assertToolsCallTaskCapability((_b = (_a = this._serverCapabilities) == null ? void 0 : _a.tasks) == null ? void 0 : _b.requests, method, "Server");
  }
  assertTaskHandlerCapability(method) {
    ...
    assertClientRequestTaskCapability((_a = this._capabilities.tasks) == null ? void 0 : _a.requests, method, "Client");
  }
  async ping(options) {
  ...
  isToolTask(toolName) {
    var _a, _b, _c, _d;
    if (!((_d = (_c = (_b = (_a = this._serverCapabilities) == null ? void 0 : _a.tasks) == null ? void 0 : _b.requests) == null ? void 0 : _c.tools) == null ? void 0 : _d.call)) {
      return false;
    }
...
//# sourceMappingURL=@modelcontextprotocol_sdk_client_index__js.js.map
