...
async function auth(provider, options) {
  ...
  try {
    ...
    if (error instanceof InvalidClientError || error instanceof UnauthorizedClientError) {
      await ((_a = provider.invalidateCredentials) == null ? void 0 : _a.call(provider, "all"));
      return await authInternal(provider, options);
...
async function authInternal(provider, { serverUrl, authorizationCode, scope, resourceMetadataUrl, fetchFn }) {
  ...
  if (!clientInformation) {
    ...
    if (shouldUseUrlBasedClientId) {
      ...
      await ((_a = provider.saveClientInformation) == null ? void 0 : _a.call(provider, clientInformation));
    } else {
...
async function discoverOAuthProtectedResourceMetadata(serverUrl, opts, fetchFn = fetch) {
  ...
  if (!response || response.status === 404) {
    await ((_a = response == null ? void 0 : response.body) == null ? void 0 : _a.cancel());
...
var StreamableHTTPClientTransport = class {
  ...
  async _commonHeaders() {
    ...
    const extraHeaders = normalizeHeaders((_a = this._requestInit) == null ? void 0 : _a.headers);
    return new Headers({
      ...headers,
      ...extraHeaders
    });
  ...
  _scheduleReconnection(options, attemptCount = 0) {
    ...
    if (attemptCount >= maxRetries) {
      (_a = this.onerror) == null ? void 0 : _a.call(this, new Error(`Maximum reconnection attempts (${maxRetries}) exceeded.`));
      return;
    }
    ...
    this._reconnectionTimeout = setTimeout(() => {
      this._startOrAuthSse(options).catch((error) => {
        var _a2;
        (_a2 = this.onerror) == null ? void 0 : _a2.call(this, new Error(`Failed to reconnect SSE stream: ${error instanceof Error ? error.message : String(error)}`));
