    ...
    <Switch>
      ...
      */}
      ...
      {features.nostr && <WrappedRoute path='/soapbox/admin/ditto-server' adminOnly page={WidePage} component={ManageDittoServer} content={children} exact />}
       ...
       <WrappedRoute path='/merchant' page={DefaultPage} component={MerchantHub} content={children} exact />
       <WrappedRoute path='/experts' page={DefaultPage} component={ExpertAI} content={children} exact />
