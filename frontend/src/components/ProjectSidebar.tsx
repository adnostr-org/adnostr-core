...
import { Plus, Folder, GitBranch, Loader2, ChevronDown, ChevronRight, Star, Columns2, X, Settings, HelpCircle, Search, Tag, Folders, Terminal } from 'lucide-react';
      ...
      <div className="border-t border-sidebar-border bg-gradient-to-r from-primary/5 to-accent/5 mt-auto pb-safe">
        <div className="p-2 flex items-center gap-2">
          <Button
            ...
            onClick={() => navigateAndClose('/oracle')}
          >
            <Terminal className="h-4 w-4 transition-colors duration-200" />
            Oracle
          </Button>
          <Button
            variant="ghost"
