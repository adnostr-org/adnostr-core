...
// AdNostr industrial icons
import buildingStorefrontIcon from '@tabler/icons/outline/building-storefront.svg';
import robotIcon from '@tabler/icons/outline/robot.svg';
    ...
    <Stack justifyContent='between' className='min-h-screen py-6'>
      <Stack space={6}>
        ...
        <Stack space={2}>
          ...
          {/* Hidden social features for industrial focus */}
